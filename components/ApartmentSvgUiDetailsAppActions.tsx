...
export default function ApartmentSvgUiDetailsAppActions({
  propertyDetails
}: {
  propertyDetails: {
    id: string;
  ...
  return (
    <div className="svg__based__selling__ui__content__app__actions">
      <button
        onClick={() => setAppView(0)}
        className={
          "svg__based__selling__ui__content__app__actions__button" +
          (appView === 0 ? " active" : "")
        }
      >
        <div className="svg__based__selling__ui__content__app__actions__button__svg">
          <svg
            width="60"
            height="80"
            viewBox="0 0 60 80"
      ...
      {propertyDetails.images.length > 0 && (
        <>
          ...
          <button
            ...
            className="svg__based__selling__ui__content__app__actions__button"
          >
            <div className="svg__based__selling__ui__content__app__actions__button__svg">
              {isPending ? (
