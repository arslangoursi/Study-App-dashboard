...
export default function ApartmentSvgUiDetailsActions() {
  const { theme, setTheme } = useTheme();
  const [language, setLanguage] = useLanguage();
  const [showHighlights, setShowHighlights] = useQueryState(
    "showHighlights",
    parseAsBoolean.withDefault(true)
  );

  return (
    <div className="svg__based__selling__ui__content__actions">
      <MapCart />
      <button
        type="button"
        className="svg__based__selling__ui__content__actions__button"
